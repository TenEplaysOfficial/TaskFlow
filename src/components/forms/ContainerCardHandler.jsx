...
function ContainerCardHandler({ handleToggle,onSubmit, title, placeholder = 'Type...', btnText = 'Submit', toastMSG = 'Notification',initialTitle ,isEdit }) {
  ...
  const getButtonClass = () => {
    return inputTitle === '' ? 'opacity-75 cursor-not-allowed' : '';
  };
